...
type tX509Column struct {
	...
	contentSource   func(tX509CertificateAndRevocation, tConfig) string
...
func getX509Columns() []tX509Column {
	...
	thisColumns = append(thisColumns,
		...
		tX509Column{
			...
			contentSource: func(x tX509CertificateAndRevocation, _ tConfig) string {
		...
		tX509Column{
			...
			contentSource:   func(x tX509CertificateAndRevocation, _ tConfig) string { return x.X509Certificate.Subject.String() },
		...
		tX509Column{
			...
			contentSource: func(x tX509CertificateAndRevocation, tc tConfig) string {
